...
public interface PoinMapper {
     ...
     // READ: Mengambil semua nama masyarakat dari tabel masyarakat
     @Select("SELECT idMasyarakat FROM masyarakat ")
     List<Integer> getIdMasyarakat(); 
 
     // READ: Mengambil semua kategori sampah dari tabel sampah
     @Select("SELECT idSampah FROM sampah ")
     List<Integer> getIdSampah();
 
     // READ: Mengambil semua kategori sampah dari tabel sampah
     @Select("SELECT IdTps FROM dropbox ")
     List<Integer> getidTps();
